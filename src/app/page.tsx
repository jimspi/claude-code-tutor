    ...
    <div className="fixed top-4 left-1/2 -translate-x-1/2 z-50 max-w-md w-full mx-4">
      <div className="bg-red-50 border border-red-200 rounded-xl px-5 py-4 shadow-lg flex items-start gap-3">
        ...
        <div className="flex-1">
          <p className="text-sm font-semibold text-red-800">Sign-in link expired</p>
          <p className="text-xs text-red-600 mt-1">
            Your magic link has expired or was opened in a different browser. Please request a new one.
          </p>
        </div>
        <button onClick={() => setShow(false)} className="text-red-400 hover:text-red-600 p-1">
