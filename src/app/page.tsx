  ...
  return (
    <div className="min-h-screen bg-stone-50">
      ...
      <section className="max-w-4xl mx-auto px-6 pt-8 pb-12 sm:pt-12 sm:pb-16 text-center">
        {/* Terminal-style hero */}
        <div className="max-w-2xl mx-auto mb-8 rounded-xl overflow-hidden border border-stone-200 shadow-lg">
          {/* Title bar */}
          <div className="flex items-center gap-2 px-4 py-2.5 bg-stone-900 border-b border-stone-700">
            <span className="w-3 h-3 rounded-full bg-red-400" />
            <span className="w-3 h-3 rounded-full bg-yellow-400" />
            <span className="w-3 h-3 rounded-full bg-green-400" />
            <span className="ml-2 text-xs text-stone-400 font-mono">claude-code</span>
          </div>
          {/* Terminal body */}
          <div className="bg-stone-950 px-5 py-6 sm:px-8 sm:py-8 text-left font-mono">
            <p className="text-teal-400 text-sm mb-4">
              <span className="text-stone-500">$</span> claude
            </p>
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white leading-tight mb-4">
              Learn to create with{" "}
              <span className="text-teal-400">the tools of tomorrow</span>
            </h2>
            ...
            <p className="text-teal-400 text-sm">
              <span className="text-stone-500">$</span> start learning<span className="animate-pulse">▊</span>
            </p>
          </div>
        </div>
...
export default function HomePage() {
  ...
  return hasAccess ? <Dashboard /> : <LandingPage />;
}
