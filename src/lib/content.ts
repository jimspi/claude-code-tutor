...
export const lessonContent: Record<string, LessonContent> = {
  ...
  "5-2": {
    ...
    blocks: [
      ...
      {
        type: "paragraph",
        text: "Back in Level 1, you set up Git and GitHub, created your first repository, and pushed code. Those basics will carry you far. But when you start working on bigger projects — or collaborating with others — you need a more structured workflow. This lesson covers the pro-level GitHub patterns that keep projects organized and code quality high.",
      },
      {
        type: "tip",
        text: "Everything in this lesson assumes you already have Git configured, a GitHub account connected, and at least one repo you've pushed to. If any of that sounds unfamiliar, revisit Lesson 1-6 first.",
      },
      {
        type: "subheading",
      ...
      },
      {
        ...
        text: "A Pull Request (PR) is a formal proposal to merge changes from one branch into another. Instead of merging code directly, you open a PR on GitHub that says \"here are my changes — please review them before they go into the main project.\" It creates a dedicated page where you (or teammates) can see exactly what changed, leave comments, and approve the work. Even if you're working solo, PRs give you a checkpoint to review your own work before it hits the main branch.",
      },
      {
        type: "paragraph",
        text: "Think of a Pull Request like submitting a draft for review before publishing. You could publish directly, but running it through a review step catches mistakes and keeps quality high.",
      },
      {
        type: "step",
        number: 1,
        title: "Create a feature branch and make changes",
        text: "Start by working on a separate branch. Make your changes and commit them as usual:",
      },
      {
        type: "code",
        code: "Create a new branch called feature/user-profiles,\nswitch to it, and push it to GitHub",
        language: "text",
        label: "Setting up a feature branch",
      },
      {
        type: "step",
        number: 2,
        title: "Open a Pull Request with Claude Code",
        text: "Once your changes are committed and pushed, ask Claude to create the PR for you:",
      },
      {
        type: "code",
        code: "Create a pull request for this branch. Use a clear title\nand write a description that summarizes what changed and why.",
        language: "text",
        label: "Creating a PR through Claude Code",
      },
      {
        type: "paragraph",
        text: "Claude will use the GitHub CLI to open the PR, generate a meaningful title from your changes, and write a description that explains what the code does. You will see the PR appear on your GitHub repository page, ready for review.",
      },
      {
        type: "step",
        number: 3,
        title: "Merge the PR when ready",
        text: "After reviewing (more on that below), you can merge directly from GitHub's web interface, or ask Claude:",
      },
      {
        type: "code",
        code: "Merge my open pull request for feature/user-profiles\ninto main and delete the branch afterward",
        language: "text",
        label: "Merging a PR via Claude Code",
      },
      {
        type: "subheading",
        text: "Branch Strategy: Keeping Your Project Clean",
      },
      {
        type: "paragraph",
        text: "When you're juggling multiple features or fixes, a clear branch naming strategy prevents chaos. The idea is simple: the main branch always contains working, stable code. All new work happens on separate branches that get merged in through PRs.",
      },
      {
        type: "concept",
        title: "Branch naming conventions",
        text: "Use prefixes that describe the type of work: feature/dark-mode for new features, fix/login-bug for bug fixes, refactor/cleanup-api for code reorganization, and docs/update-readme for documentation changes. The prefix tells you (and anyone else) what kind of work the branch contains at a glance. After the prefix, use short descriptive names with hyphens — no spaces.",
      },
      {
        type: "code",
        code: "Create a new branch for fixing the broken search\nfilter on the products page",
        language: "text",
        label: "Claude will name it something like fix/search-filter",
      },
      {
        type: "accordion",
        title: "A typical branch workflow, step by step",
        content: "1. You're on the main branch with stable code.\n2. You create a new branch: feature/shopping-cart.\n3. You build the shopping cart, committing as you go.\n4. You push the branch and open a Pull Request.\n5. You review the changes (or have Claude review them).\n6. You merge the PR into main.\n7. You delete the feature branch — it served its purpose.\n8. Main now has the shopping cart feature, and you start fresh with the next branch.",
      },
      {
        type: "tip",
        text: "Never commit work-in-progress directly to main. Even for small fixes, get in the habit of creating a branch. It takes seconds and gives you the freedom to experiment without risk.",
      },
      {
        type: "subheading",
      ...
      {
        type: "paragraph",
        text: "One of the most powerful things you can do before merging code is to have Claude review it. Professional developers do code reviews all the time — it catches bugs, improves readability, and surfaces edge cases you might have missed. Claude can act as your tireless code reviewer.",
      },
      {
        type: "step",
        number: 1,
        title: "Review before committing",
        text: "Before you even commit, ask Claude to look over what you've changed:",
      },
      {
        type: "code",
        code: "Review my current changes and suggest improvements.\nLook for bugs, security issues, and anything that\ncould be cleaner.",
        language: "text",
      ...
      },
      {
        type: "step",
        number: 2,
        title: "Review a full branch before merging",
        text: "For a bigger-picture review, ask Claude to compare your branch against main:",
      },
      {
        type: "code",
        code: "Compare this branch to main and review all the\ndifferences. Summarize the changes, flag any concerns,\nand rate the overall code quality.",
        language: "text",
        label: "Branch review before merging",
      },
      {
        type: "paragraph",
        text: "Claude will look at every file that changed, explain what each change does, and point out potential problems. It is like having a senior developer do a code review for you on demand.",
      },
      {
        type: "subheading",
      ...
      },
      {
        ...
        text: "A merge conflict happens when two branches change the same part of the same file, and Git cannot figure out which version to keep. For example, if you edited line 10 of a file on your feature branch, and someone else (or you on another branch) also edited line 10 differently, Git will stop and say: \"I don't know which version you want — you need to decide.\" This sounds scary, but Claude Code handles it gracefully.",
      },
      {
        type: "paragraph",
        text: "In traditional development, merge conflicts can be stressful. You have to open the file, find the conflict markers, understand both versions, and manually pick the right code. With Claude Code, you describe what you want and it resolves the conflict for you.",
      },
      {
        type: "code",
        code: "There are merge conflicts after pulling from main.\nResolve them by keeping my new feature code but\nmaking sure it works with the latest changes from main.",
        language: "text",
        label: "Resolving merge conflicts with Claude",
      },
      {
        type: "tip",
        text: "To reduce merge conflicts in the first place, pull changes from main into your feature branch regularly. Ask Claude: \"Pull the latest changes from main into my current branch.\" Frequent small merges are much easier than one big merge at the end.",
      },
      {
        type: "subheading",
        text: "GitHub Issues: Tracking Bugs and Features",
      },
      {
        type: "paragraph",
        text: "GitHub Issues are a built-in task tracker. Each issue describes a bug to fix, a feature to build, or an improvement to make. They give your project a clear to-do list that lives right alongside your code.",
      },
      {
        type: "step",
        number: 1,
        title: "Create an issue with Claude",
        text: "When you spot a bug or think of a feature, have Claude create an issue for you:",
      },
      {
        type: "code",
        code: "Create a GitHub issue titled \"Add password reset flow\"\nwith a description that outlines the steps needed:\nemail input, verification code, new password form.",
        language: "text",
        label: "Creating a GitHub issue",
      },
      {
        type: "step",
        number: 2,
        title: "Reference issues in your commits",
        text: "When you fix a bug or build a feature that relates to an issue, reference it in your commit. GitHub will automatically link them together:",
      },
      {
        type: "code",
        code: "Commit these changes with a message that references\nGitHub issue #12. The commit should close the issue.",
        language: "text",
        label: "Linking commits to issues",
      },
      {
        type: "paragraph",
        text: "Claude will write a commit message like \"Add password reset flow (closes #12)\". When this gets merged into main, GitHub automatically closes issue #12. Everything stays connected and organized.",
      },
      {
        type: "step",
        number: 3,
        title: "View and manage your issues",
        text: "Ask Claude to check on your open issues anytime:",
      },
      {
        type: "code",
        code: "List all open GitHub issues for this repo and\nsummarize them",
        language: "text",
        label: "Checking your open issues",
      },
      {
        type: "subheading",
        text: "Advanced GitHub Prompts",
      },
      {
        type: "paragraph",
        text: "Here are some powerful prompts that combine the concepts from this lesson. Each one handles a workflow that would normally require multiple Git commands and GitHub clicks.",
      },
      {
        type: "prompt-card",
        phrase: "Create a branch, implement the fix for issue #7, commit it, push it, and open a PR that references the issue",
        explanation: "This is a full workflow in one prompt. Claude will create a branch, write the fix, commit with an issue reference, push to GitHub, and open a Pull Request — all in one shot.",
      },
      {
        type: "prompt-card",
        phrase: "Review the open PR #3 and leave a summary comment with your assessment",
        explanation: "Claude will read through the PR's changes, analyze the code, and post a review comment on GitHub summarizing what it found.",
      },
      {
        type: "prompt-card",
        phrase: "Show me all branches that haven't been merged and tell me what each one contains",
        explanation: "Great for cleaning up a project. Claude will list stale branches and describe the unmerged work in each one so you can decide what to keep or delete.",
      },
      {
        type: "prompt-card",
        phrase: "Squash all my commits on this branch into one clean commit with a good message, then force push",
        explanation: "When you have a messy history of small commits like \"fix typo\" and \"oops, try again\", squashing combines them into one polished commit before merging.",
      },
      {
        type: "prompt-card",
        phrase: "Set up branch protection rules for main so that all changes require a PR",
        explanation: "Claude will walk you through configuring GitHub's branch protection settings. This prevents anyone (including you) from pushing directly to main — all changes must go through a Pull Request.",
      },
      {
        type: "accordion",
        title: "When should I use these workflows vs. the basics?",
        content: "If you're working on a small personal project alone, the basics from Level 1 (commit and push to main) work just fine. Start using branches, PRs, and issues when: your project grows beyond a few files, you want a safety net before merging changes, you're collaborating with someone else, or you want a clear history of what changed and why. There's no penalty for using them early, though — they're good habits that scale with you.",
      },
      {
        type: "quiz",
        question: "What is the main benefit of using a Pull Request instead of merging directly into main?",
        options: [
          "It makes your code run faster",
          "It gives you a chance to review changes before they become part of the main project",
          "It automatically fixes bugs in your code",
          "It is required by Git — you cannot merge without one",
        ],
        correctIndex: 1,
        explanation: "A Pull Request creates a review checkpoint. It lets you (or others) see exactly what changed, discuss the code, and catch problems before the changes are merged into the main branch. It's not required by Git, but it's a best practice used by professional teams everywhere.",
      },
    ],
  },
  "5-3": {
